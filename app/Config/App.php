...
class App extends BaseConfig
{
     ...
     *    http://example.com/
     */ 
    // public string $baseURL = ($_SERVER['SERVER_PORT'] == 443 ? 'https' : 'http') . "://{$_SERVER['SERVER_NAME']}".str_replace(basename($_SERVER['SCRIPT_NAME']),"",$_SERVER['SCRIPT_NAME']);
    // public string $baseURL = 'http://54.198.103.58/';

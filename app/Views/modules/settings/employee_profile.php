                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon input-icon-right">
                                    <input required required type="text" id="name" class="form-control form-control-pill form_hospital_add_fields" name="name" placeholder="Name" value="NAME" />
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="form-group">
                                ...
                                <div class="input-icon input-icon-right">
                                    <input required required type="text" id="name" class="form-control form-control-pill form_hospital_add_fields" name="name" placeholder="E Mail" value="mail@admin.com" />
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <div class="input-icon input-icon-right">
                                    <input required required type="text" id="name" class="form-control form-control-pill form_hospital_add_fields" name="name" placeholder="Contact" value="+91 9061431499" />

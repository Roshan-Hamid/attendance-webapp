...
// exit(APPPATH . "Libraries/zklib/zklib.php");
...
ini_set('display_errors', 1);
    ...
    $errorMessage = property_exists($zk, 'errMsg') ? $zk->errMsg : (property_exists($zk, 'error_msg') ? $zk->error_msg : "Unknown error");
    echo "Failed to connect to ZKTeco device. Error: " . $errorMessage;
    }
...
<span></span>
<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style='color:#797997;'>$zk</span><span> </span><span style='color:#808030;'>=</span><span> </span><span style='color:#800000;font-weight:bold; '>new</span><span> ZKLib</span><span style='color:#808030;'>(</span><span style='color:#0000e6;'>"112.133.223.163"</span><span style='color:#808030;'>,</span><span> </span><span style='color:#008c00;'>4370</span><span style='color:#808030;'>)</span><span style='color:#800080;'>;</span><span></span>
<span></span>

...
(function($) {
	...
	$.fn[pluginName] = function(options) {
		...
		var Plugin = {
			...
			/**
			 * will be implemented Coming Soon
			 * @returns {jQuery}
			 */
			dataset: function() {
				return datatable;
	...
	$.fn[pluginName].defaults = {
		...
		// resize column size with mouse drag coming Coming Soon)
		resizable: false,

		// column based filtering (coming Coming Soon)
		filterable: false,

		pagination: true,

		// inline and bactch editing (cooming Coming Soon)
		editable: false,
